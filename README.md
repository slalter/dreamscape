...
3. Claude uses structured tools to create objects, set environment, add terrain, and narrate
...
- **Backend**: FastAPI + Python + Claude API (tool use)
...
~$0.01-0.03 per interaction using Claude Sonnet. A 50-interaction session costs ~$0.50-1.50.
